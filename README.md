...
$$N_{\gamma}^{total} = I_{\gamma} * T_{measurement}\,[\mathrm{hours}] * \frac{3600 \, \mathrm{[seconds]}}{1 \mathrm{[hours]}} * A(T_{measurement}) \, \mathrm{[kBq]\, \frac{1000\,[Bq]}{[kBq]} \, \frac{\#/[seconds]}{[Bq]} }$$
